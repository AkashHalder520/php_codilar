...
<body>
    <div class="container mt-5">
        ...
        $sqlfetchquery = "SELECT profile_img,name,email,mobile,gender,city,education  FROM `user_details` WHERE id=$id";
        ...
        <form method="post" action="./updatescript.php?id=<?php echo $id ?>" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="mobileid" name="mobile" value="<?php echo $data[0]['mobile']; ?>">
                    <span id="err"> </span>
                </div>
            </div>
            <!-- <div class="row mb-3">
